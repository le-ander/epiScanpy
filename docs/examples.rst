...
The tutorial can be found `here <./docs/tutorials/ATAC_bld_ct_mtx_tutorial.html>`__. 
...
The first tutorial shows how to build the count matrices for the different feature spaces (windows, promoters) in different cytosine contexts. Here is the  `tutorial  <./docs/tutorials/bld_count_matrix_methylation_tutorial.html>`__.
